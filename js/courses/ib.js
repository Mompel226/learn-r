      ...
      { id: 'r-basics', title: 'R in ten minutes',
        ...
        blocks: [
          ...
          { type: 'concept', title: 'What R is',
            md: 'Scientists use R to calculate, draw graphs and run statistical tests. You type a line of code, press **Run**, and R answers underneath.\n\nIn this course, R runs inside the page. The page downloads R when you open it (that is the wait at the start), but nothing is installed on your computer. Only the last stage shows you how to install R, for your IA or EE.' },
